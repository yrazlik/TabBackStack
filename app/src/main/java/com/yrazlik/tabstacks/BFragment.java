...
public class BFragment extends Fragment{
    ...
    public void onAttach(Context context) {
        ...
        Log.d("THETABSTACKAPP", "THETABSTACKAPP B onAttach()");
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        Log.d("THETABSTACKAPP", "THETABSTACKAPP B onActivityCreated()");
    }

    @Override
    public void onStart() {
        super.onStart();
        Log.d("THETABSTACKAPP", "THETABSTACKAPP B onStart()");
    }

    @Override
    public void onResume() {
        super.onResume();
        Log.d("THETABSTACKAPP", "THETABSTACKAPP B onResume()");
    }

    @Override
    public void onPause() {
        super.onPause();
        Log.d("THETABSTACKAPP", "THETABSTACKAPP B onPause()");
    }

    @Override
    public void onStop() {
        super.onStop();
        Log.d("THETABSTACKAPP", "THETABSTACKAPP B onStop()");
    }

    @Override
    public void onDestroyView() {
        super.onDestroyView();
        Log.d("THETABSTACKAPP", "THETABSTACKAPP B onDestroyView()");
    }

    @Override
    public void onDestroy() {
        super.onDestroy();
        Log.d("THETABSTACKAPP", "THETABSTACKAPP B onDestroy()");
    }

    @Override
    public void onDetach() {
        super.onDetach();
        Log.d("THETABSTACKAPP", "THETABSTACKAPP B onDetach()");
    }
}
